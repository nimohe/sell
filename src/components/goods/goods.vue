<template>
  <div class="goods">
    ...
    <div class="goods-wrapper"  ref="food-wrapper">
      <ul>
    ...
    .menu-wrapper{
      ...
      .menu-item{
        ...
        .icon{
          ...
          &.decrease{
            @include bg-image('../../../static/images/decrease_3');
          }
          &.discount{
            @include bg-image('../../../static/images/discount_3');
          }
          &.guarantee{
            @include bg-image('../../../static/images/guarantee_3');
          }
          &.invoice{
            @include bg-image('../../../static/images/invoice_3');
          }
          &.special{
            @include bg-image('../../../static/images/special_3');
          }
        }
        .text{
          display: table-cell;
